...
local Label = require(script.Parent:FindFirstChild('Label'))
local NumericInput = require(script.Parent:FindFirstChild('NumericInput'))

local useMouseDrag = require(script.Parent.Parent:FindFirstChild('Hooks'):FindFirstChild('useMouseDrag'))
