...
local ReactRoblox = require(script.Parent.Parent.Parent:FindFirstChild('react-roblox'))
...
local ScrollFrame = require(script.Parent:FindFirstChild('ScrollFrame'))

local ClearButton = require(script:FindFirstChild('ClearButton'))
local DropdownItem = require(script:FindFirstChild('DropdownItem'))
local DropdownTypes = require(script:FindFirstChild('Types'))
