...
local BaseTextInput = require(script.Parent:FindFirstChild('Foundation'):FindFirstChild('BaseTextInput'))
local Slider = require(script.Parent:FindFirstChild('Slider'))

local Constants = require(script.Parent.Parent:FindFirstChild('Constants'))
local useFreshCallback = require(script.Parent.Parent:FindFirstChild('Hooks'):FindFirstChild('useFreshCallback'))
